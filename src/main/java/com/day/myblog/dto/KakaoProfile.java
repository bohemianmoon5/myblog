...
public class KakaoProfile {
	...
	public class KakaoAccount {
		...
		public KakaoAccount(Boolean profileNicknameNeedsAgreement, Boolean profileImageNeedsAgreement, Profile profile,
				Boolean hasEmail, Boolean emailNeedsAgreement, Boolean isEmailValid, Boolean isEmailVerified,
				String email) {
			super();
			this.profile_nickname_needs_agreement = profileNicknameNeedsAgreement;
			this.profile_image_needs_agreement = profileImageNeedsAgreement;
			this.profile = profile;
			this.has_email = hasEmail;
			this.email_needs_agreement = emailNeedsAgreement;
			this.is_email_valid = isEmailValid;
		...
		public String toString() {
			return "KakaoAccount [profile_nickname_needs_agreement=" + profile_nickname_needs_agreement
					+ ", profile_image_needs_agreement=" + profile_image_needs_agreement + ", profile=" + profile
					+ ", has_email=" + has_email + ", email_needs_agreement=" + email_needs_agreement
		...
		public class Profile {
			...
			public Profile(String nickname, String thumbnailImageUrl, String profileImageUrl, Boolean isDefaultImage) {
				super();
				this.nickname = nickname;
				this.thumbnail_image_url = thumbnailImageUrl;
				this.profile_image_url = profileImageUrl;
				this.is_default_image = isDefaultImage;
			}
